const currentURL = "https://api.openweathermap.org/data/2.5/weather?id=5607916&appid=fd74cb44a609831d55dcf1e741ec4e9b";
fetch(currentURL)
...
const apiURL = "https://api.openweathermap.org/data/2.5/forecast?id=5607916&appid=fd74cb44a609831d55dcf1e741ec4e9b";
fetch(apiURL)
  .then((response) => response.json())
